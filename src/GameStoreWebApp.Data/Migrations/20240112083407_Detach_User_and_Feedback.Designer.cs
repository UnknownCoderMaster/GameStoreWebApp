...
namespace GameStoreWebApp.Data.Migrations
{
    ...
    [Migration("20240112083407_Detach_User_and_Feedback")]
    partial class Detach_User_and_Feedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStoreWebApp.Domain.Entities.Users.Verification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameStoreWebApp.Domain.Entities.Feedbacks.Feedback", b =>
                {
                    b.HasOne("GameStoreWebApp.Domain.Entities.Users.User", null)
                        .WithMany("Feedbacks")
